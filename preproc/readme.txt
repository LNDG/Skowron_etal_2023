preproc_detrend_filter_excecute Executable
...
================================
-preproc_detrend_filter_excecute 
-run_preproc_detrend_filter_excecute.sh (shell script for temporarily setting environment 
                                         variables and executing the application)
   -to run the shell script, type
   
       ./run_preproc_detrend_filter_excecute.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v93, run the shell script as:
       ...
       ./run_preproc_detrend_filter_excecute.sh /mathworks/home/application/v93
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_preproc_detrend_filter_excecute.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
${LD_LIBRARY_PATH}:MR/v93/runtime/glnxa64:MR/v93/bin/glnxa64:MR/v93/sys/os/glnxa64:MR/v93/sys/opengl/lib/glnxa64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_preproc_detrend_filter_excecute.sh 
