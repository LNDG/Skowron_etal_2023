function replace_mean_with_pMod_beta
...
pn.root = '/home/mpib/LNDG/Entscheidung2/analysis/trial-wise_PLS/pMod_mean_analysis/results/';
pn.meanFiles = [pn.root, 'mean_datamats/'];
pn.sdFiles = [pn.root, 'beta_datamats/'];
pn.sdniftis = '/home/mpib/LNDG/Entscheidung2/analysis/GLM/results/pMod_mean/';
...
load (['/home/mpib/LNDG/Entscheidung2/analysis/trial-wise_PLS/pMod_mean_analysis/A_PLS/coords_EVAL.mat'], 'final_coords');
...
for indID = 1:numel(SubjectID)
    ...
    fname = dir([pn.sdniftis, SubjectID{indID} '/con_0001.nii' ]);
    fname = fname.name;
