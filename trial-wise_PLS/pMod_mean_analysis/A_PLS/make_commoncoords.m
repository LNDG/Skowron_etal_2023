...
DATAPATH=([BASEPATH 'analysis/GLM/results/pMod_mean']);
SAVEPATH=([BASEPATH, 'analysis/trial-wise_PLS/pMod_mean_analysis/A_PLS/coords_EVAL.mat']);
...
for i = 1:numel(SubjectID)
            ...
            NIINAME=dir([NIIPATH '/con_0001.nii']);
