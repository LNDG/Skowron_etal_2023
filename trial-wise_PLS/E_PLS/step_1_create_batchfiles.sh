...
for SID in $SubjectID; do
	...
	dummy_s1="dummy_s1"
	s1_dir="${ScriptsPath}/data/sd_niftis_allCond/${SID}/s1/${SID}_allCond_sd_s1_sd.nii"
	
	dummy_s2="dummy_s2"
	s2_dir="${ScriptsPath}/data/sd_niftis_allCond/${SID}/s2/${SID}_allCond_sd_s2_sd.nii"
	
	dummy_s3="dummy_s3"
	s3_dir="${ScriptsPath}/data/sd_niftis_allCond/${SID}/s3/${SID}_allCond_sd_s3_sd.nii"
	
	dummy_s4="dummy_s4"
	s4_dir="${ScriptsPath}/data/sd_niftis_allCond/${SID}/s4/${SID}_allCond_sd_s4_sd.nii"
	
	dummy_s5="dummy_s5"
	s5_dir="${ScriptsPath}/data/sd_niftis_allCond/${SID}/s5/${SID}_allCond_sd_s5_sd.nii"
	
	dummy_grid="dummy_grid"
	grid_dir="${ScriptsPath}/data/sd_niftis_allCond/${SID}/grid/${SID}_allCond_sd_grid_sd.nii"
	
	dummy_dec="dummy_dec"
	dec_dir="${ScriptsPath}/data/sd_niftis_allCond/${SID}/dec/${SID}_allCond_sd_dec_sd.nii"
