...
pn.root = '/home/mpib/LNDG/Entscheidung2/analysis/trial-wise_PLS/pMod_analysis/results/';
...
load (['/home/mpib/LNDG/Entscheidung2/analysis/trial-wise_PLS/pMod_analysis/A_PLS/coords_EVAL.mat'], 'final_coords');
...
for indID = 1:numel(SubjectID)
    ...
    fname = dir([pn.sdniftis, SubjectID{indID} '/con_0007.nii' ]);
    fname = fname.name;
