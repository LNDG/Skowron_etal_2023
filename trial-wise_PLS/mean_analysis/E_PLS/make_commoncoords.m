...
DATAPATH=([BASEPATH 'analysis/trial-wise_PLS/mean_analysis/data/mean_niftis_allCond']);
SAVEPATH=([BASEPATH, 'analysis/trial-wise_PLS/mean_analysis/E_PLS/coords_EVAL.mat']);
...
for i = 1:numel(SubjectID)
        for j = 1:numel(SessionID)
            ...
            NIINAME=dir([NIIPATH '/con_000' SessionID{j} '.nii']);
