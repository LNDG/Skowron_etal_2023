...
% get info
load('/Users/skowron/Volumes/tardis/LNDG/Entscheidung2/analysis/trial-wise_PLS/mean_analysis/results/allCond/beta_datamats/meanChange_ranked_errorOnlyRANK_N47_BehPLS_BfMRIresult.mat','result','subj_name')
estim_error_rank = result.stacked_behavdata;


PLS_result_path='/Users/skowron/Volumes/tardis/LNDG/Entscheidung2/analysis/trial-wise_PLS/mean_analysis/results/allCond/beta_datamats';
...
fname = '/Users/skowron/Volumes/tardis/LNDG/Entscheidung2/analysis/trial-wise_PLS/mean_analysis/figures/allCond_ranked_errorOnly_BehPLS_BfMRIbsr_lv1_thr2.nii.gz';
...
% load common coords
load('/Users/skowron/Volumes/tardis/LNDG/Entscheidung2/analysis/trial-wise_PLS/mean_analysis/E_PLS/coords_EVAL.mat')
...
for i = 1:length(subj_name)
    ...
    pMod_pos_effect(i,:) = st_datamat(8,mask_coords_pos);
    pMod_neg_effect(i,:) = st_datamat(8,mask_coords_neg);
    
end

% plot median pMod effect against estimation error
plot(estim_error_rank,median(pMod_pos_effect,2),'bo')
title('mean slope  effectin BSR > 3 regions')
ylabel('mean slope effect')
...
title('mean slope effect in BSR < 3 regions')
ylabel('mean slope effect')
xlabel('estimation error (rank)')
lsline
...
ylabel('mean slope effect in neg BSRs')
xlabel('mean slope effect in pos BSRs')
lsline
