...
for SID in $SubjectID; do
	...
	cp ${ScriptsPath}/G_PLS/make_batch_template.txt ${MeanPLS}/${SID}_meanbold_batch.txt
	...
	s1_dir="${ScriptsPath}/results/pMod_var_norm/${SID}/ResSD_s1.nii"
	
	dummy_s2="dummy_s2"
	s2_dir="${ScriptsPath}/results/pMod_var_norm/${SID}/ResSD_s2.nii"
	
	dummy_s3="dummy_s3"
	s3_dir="${ScriptsPath}/results/pMod_var_norm/${SID}/ResSD_s3.nii"
	
	dummy_s4="dummy_s4"
	s4_dir="${ScriptsPath}/results/pMod_var_norm/${SID}/ResSD_s4.nii"
	
	dummy_s5="dummy_s5"
	s5_dir="${ScriptsPath}/results/pMod_var_norm/${SID}/ResSD_s5.nii"
