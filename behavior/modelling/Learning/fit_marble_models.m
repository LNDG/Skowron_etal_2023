...
% save results
save('Bayes_expo_par_fit.mat','theta','LL')
...
% save results
save('Bayes_prior_par_fit.mat','theta','LL')
...
% save results
save('Bayes_rate_par_fit.mat','theta','LL')
...
% save results
save('Bayes_expo2_par_fit.mat','theta','LL')
...
% save results
save('Bayes_prior2_par_fit.mat','theta','LL')
...
% 
% % save results
% save('Bayes_rate2_par_fit.mat','theta','LL')
% 
% clear theta LL
...
% save results
save('Bayes_expo_LR_par_fit.mat','theta','LL')

clear theta LL

%% fit Bayesian updating model with free prior and learning rate
for i = 1:size(data,2)
...
% save results
save('Bayes_prior_LR_par_fit.mat','theta','LL')

clear theta LL

%% fit Bayesian updating model with free prior and learning rate and noisy choice
for i = 1:size(data,2)
    ...
    for it = 1:iter
        ...
        theta_start = [20*rand+1 0.5*rand rand*2]; % starting value for optimisation
        theta_lb = [1 0 0];
...
%% fit Bayesian updating model with learning rate and noisy choice
for i = 1:size(data,2)
    ...
    for it = 1:iter
        ...
        theta_start = [0.5*rand rand*2]; % starting value for optimisation
        theta_lb = [0 0];
        theta_ub = [Inf Inf];

        [theta_fit LL_fit]=fmincon(@(x) Bayes_LR_model(x, nBlue_mat, N_mat, p_response),theta_start,[],[],[],[],theta_lb,theta_ub);
...
% save results
save('Bayes_LR_par_fit.mat','theta','LL')
...
% save results
save('Bayes_prior_rec_par_fit.mat','theta','LL')
...
% save results
save('Bayes_prior_rec2_par_fit.mat','theta','LL')
